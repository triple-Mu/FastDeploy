...
setup_configs["PADDLEINFERENCE_API_COMPAT_2_6_x"] = os.getenv("PADDLEINFERENCE_API_COMPAT_2_6_x", "OFF")
...
setup_configs["PADDLEINFERENCE_API_COMPAT_CUDA_SM_80"] = os.getenv("PADDLEINFERENCE_API_COMPAT_CUDA_SM_80", "OFF")
setup_configs["PADDLEINFERENCE_API_COMPAT_CUDA_SM_90"] = os.getenv("PADDLEINFERENCE_API_COMPAT_CUDA_SM_90", "OFF")
